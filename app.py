...
with col1:
    min_pe = st.number_input("Min P/E Ratio", value=10)
    min_roe = st.number_input("Min ROE (%)", value=15)
with col2:
    max_debt_equity = st.number_input("Max Debt/Equity", value=1.0)
    min_market_cap = st.number_input("Min Market Cap ($B)", value=1)
...
min_rsi = st.slider("Min RSI (Avoid Overbought)", 30, 70, 50)
min_volume = st.number_input("Min Avg Volume (Millions)", value=1)
